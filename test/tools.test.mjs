...
// 15 credits, which is the price of a canary that can fail for the right reason.
//
...
const ENDPOINT = 'https://mcp.hasdata.com/api/mcp?apis=google_travel_flights';
...
test('apis=google_travel_flights exposes exactly one tool', live, async () => {
